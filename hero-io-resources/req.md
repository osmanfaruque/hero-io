...
- Do minimum 12 commits to github Repository
- A meaning full name : App House
...
- Create an JSON Array of minimum 16-25 objects for app data using the following structure:
  ```js
  {
    image: string;
    title: string;
